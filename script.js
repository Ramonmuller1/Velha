...
function verificaDiagonais(pos1, pos2, pos3){
    ...
    if((diagonal[0] == "X" && diagonal[1] == "X" && diagonal[2] == "X")
        ...
        for(let cont in tabuleiro){
            (pos3 == "bt22") ? document.getElementById("bt" + cont + "" + cont).style.color = "white" :
            document.getElementById("bt" + cont + "" + contRegressivo--).style.color = "white" //Pinta a diagonal principal ou secundária vencedora de vermelho
            vencedor++
        }
    }
}
